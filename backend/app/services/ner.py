...
# Try to import spacy, but handle the case where it's not installed
try:
    import spacy
    SPACY_AVAILABLE = True
except ImportError:
    logger.warning("spaCy is not installed. NER functionality will be limited.")
...
class NamedEntityRecognizer:
    ...
    def __init__(self):
        ...
        if not SPACY_AVAILABLE:
            logger.warning("spaCy is not available. NER functionality will be disabled.")
            return
